...
% type e
\newcommand{\lambde}[1]{\ensuremath{\lambda #1 : #1 \in D_{\te}\, .\,}}
\newcommand{\lambdes}[1]{\ensuremath{\lambda #1_{\te}\, .\,}}

% type <et>
\newcommand{\lambdet}[1]{\ensuremath{\lambda #1 : #1 \in D_{\tet}\, .\,}}
\newcommand{\lambdets}[1]{\ensuremath{\lambda #1_{\tet}\, .\,}}

% type agnostic
\newcommand{\lambdagn}[2]{\ensuremath{\lambda #1 : #1 \in D_{\tagn{#2}}\, .\,}}
